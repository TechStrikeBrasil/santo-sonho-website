...
export const Route = createFileRoute("/_site/contato")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Fale com a Santo Sonho Colchões pelo WhatsApp, e-mail ou redes sociais. Atendimento rápido e humano." },
      { property: "og:title", content: "Contato — Santo Sonho Colchões" },
      { property: "og:description", content: "Fale conosco pelo WhatsApp ou e-mail." },
    ],
  }),
  component: Contato,
});
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <a href={SITE.instagram} target="_blank" rel="noreferrer" className="flex items-center gap-3 p-5 rounded-2xl bg-card border border-border hover:border-[var(--brand)]/40 transition">
              <Instagram className="size-6 text-[var(--brand)]" />
              <div>
            ...
            <a href={SITE.facebook} target="_blank" rel="noreferrer" className="flex items-center gap-3 p-5 rounded-2xl bg-card border border-border hover:border-[var(--brand)]/40 transition">
              <Facebook className="size-6 text-[var(--brand)]" />
              <div>
