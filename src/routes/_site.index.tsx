...
export const Route = createFileRoute("/_site/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Colchões, box e acessórios das melhores marcas. 11 lojas no ABC e em São Paulo. Atendimento humano e preços justos." },
      { property: "og:title", content: "Santo Sonho Colchões" },
      { property: "og:description", content: "Colchões, box e acessórios. 11 lojas no ABC e em São Paulo." },
    ],
  }),
  component: Home,
});
