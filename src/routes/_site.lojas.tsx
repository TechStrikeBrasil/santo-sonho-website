...
export const Route = createFileRoute("/_site/lojas")({
  head: () => ({
    meta: [
      { title: "Nossas Lojas — Santo Sonho Colchões" },
      { name: "description", content: "11 lojas Santo Sonho Colchões no ABC, São Paulo e Ribeirão Pires. Encontre a mais próxima de você." },
      { property: "og:title", content: "Lojas Santo Sonho Colchões" },
      { property: "og:description", content: "Encontre a loja Santo Sonho mais próxima de você." },
    ],
  }),
  component: Lojas,
});
