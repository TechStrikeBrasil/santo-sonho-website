...
export const Route = createFileRoute("/_site/produtos")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Conheça o catálogo Santo Sonho: colchões casal, queen, king, solteiro, box e acessórios das melhores marcas." },
      { property: "og:title", content: "Catálogo — Santo Sonho Colchões" },
      { property: "og:description", content: "Colchões, box e acessórios das melhores marcas." },
    ],
  }),
  component: Produtos,
});
