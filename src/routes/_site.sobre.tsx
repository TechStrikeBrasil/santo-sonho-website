...
export const Route = createFileRoute("/_site/sobre")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Conheça a história da Santo Sonho Colchões: mais de uma década cuidando do sono das famílias do ABC e de São Paulo." },
      { property: "og:title", content: "Sobre a Santo Sonho Colchões" },
      { property: "og:description", content: "Mais de uma década cuidando do seu sono." },
    ],
  }),
  component: Sobre,
});
